...
var getKeyTypeByName = function(name){
  var typeName;
...
var generateRandomBytes = function(length) {
  return uint8ArrayToBuffer(nacl.randomBytes(length));
};

var addPrefixToError = function(prefix, err){
...
module.exports = {
  ...
  getKeyTypeByName: getKeyTypeByName,
  ...
  addPrefixToError: addPrefixToError,
