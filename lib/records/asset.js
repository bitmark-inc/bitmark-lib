...
Asset.prototype.setDescription = function(description){
  _setString(description, config.record.asset.max_description, 'description', this);this.isSigned = false;
  return this;
};

Asset.prototype.setFingerprint = function(fingerprint){
  _setString(fingerprint, config.record.asset.max_fingerprint, 'fingerprint', this);this.isSigned = false;
  return this;
};
...
Asset.prototype.sign = function(priKey){
  ...
  var keyHandler = keyHandlers.getHandler(priKey.getKeyType());
